...
class Ui_MainWindow(QMainWindow):
    ...
    def deleteApps(self):
        ...
        appsDir = r'./Bulaloi-App-Development-Experiment/next-app/public/apps-games-data/apps/'
        gamesDir = r'./Bulaloi-App-Development-Experiment/next-app/public/apps-games-data/games/'
